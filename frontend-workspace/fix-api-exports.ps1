# fix-api-exports.ps1
Write-Host "🔧 Fixing missing API exports in src/services/api.js..." -ForegroundColor Cyan
...
Set-Content -Path "src/services/api.js" -Value $apiContent -Encoding UTF8

Write-Host "✅ src/services/api.js updated with complete exports (adminAPI, clientAPI, etc.)" -ForegroundColor Green
