...
// Context Providers (all now imported through AppProviders)
...
const stripePromise = loadStripe(process.env.VITE_STRIPE_PUBLIC_KEY || "pk_test_mock");
    ...
    <ErrorBoundary 
      fallback={
        <div className="ai-route-error">
          ...
          <p>We're optimizing this route for you...</p>
