      ...
      <div className="container-custom py-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">Connecting talent with opportunity through AI.</p>
          </div>
          <div>
            <h4 className="font-semibold mb-3">Platform</h4>
            <ul className="space-y-2 text-sm">
              <li><Link to="/browse" className="text-gray-600 dark:text-gray-400 hover:text-indigo-600">Browse Jobs</Link></li>
              <li><Link to="/how-it-works" className="text-gray-600 dark:text-gray-400 hover:text-indigo-600">How it Works</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/blog" className="text-gray-600 dark:text-gray-400 hover:text-indigo-600">Blog</Link></li>
